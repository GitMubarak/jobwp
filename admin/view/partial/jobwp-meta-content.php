...
<table class="form-table">
    <tr class="jobwp_experience">
        <th scope="row">
            <label for="jobwp_experience"><?php esc_html_e('Experience:', JOBWP_TXT_DOMAIN); ?></label>
        </th>
        <td>
    ...
    <tr class="jobwp_vacancies">
        <th scope="row">
            <label for="jobwp_vacancies"><?php esc_html_e('No. of Vacancies:', JOBWP_TXT_DOMAIN); ?></label>
        </th>
        <td>
    ...
    <tr class="jobwp_nature">
        <th scope="row">
            <label for="jobwp_nature"><?php esc_html_e('Job Nature:', JOBWP_TXT_DOMAIN); ?></label>
        </th>
        <td>
    ...
    <tr class="jobwp_level">
        <th scope="row">
            <label for="jobwp_level"><?php esc_html_e('Job Level:', JOBWP_TXT_DOMAIN); ?></label>
        </th>
        <td>
    ...
    <tr class="jobwp_location">
        <th scope="row">
            <label for="jobwp_location"><?php esc_html_e('Job Location:', JOBWP_TXT_DOMAIN); ?></label>
        </th>
        <td>
    ...
    <tr class="jobwp_edu_req">
        <th scope="row">
            <label for="jobwp_edu_req"><?php esc_html_e('Educational Requirements:', JOBWP_TXT_DOMAIN); ?></label>
        </th>
        <td>
    ...
    <tr class="jobwp_deadline">
        <th scope="row">
            <label for="jobwp_deadline"><?php esc_html_e('Deadline:', JOBWP_TXT_DOMAIN); ?></label>
        </th>
        <td>
